                                                ...
                                                <div class="cbp-added">
                                                    @if ($i == 4)
                                                        @for ($j = ($loop*3); $j < $length; $j++, $count++)
                                                            <a href="{{ url('/category/'.$categoryListArray[$count]['categoryNameSlug']) }}" class="cbpc-link"><i class="fa fa-angle-right"></i> {{ $categoryListArray[$count]['categoryName'] }}</a>
                                                        @endfor
                                                    @else
...
<div class="c3-home demo-1" style="background-image:url('public/images/bg3.jpg');">
    <div id="large-header" class="large-header">
        <div class="container">
            <div id="particles-js"></div>
            <h2 class="main-title home-h2">Unitouch Packaging & <br>Automation</h2>
            <p class="main-title home-p">Being a prominent manufacturer and supplier of the industry, we are offering a wide assortment of Labelling and Packaging Machinery.</p>
            <div class="main-title home-link">
                <a href="{{ url('/product') }}" class="">Products</a>
                <a href="{{ url('/contact') }}" class="">Contact Us</a>
            </div>
        </div>
    </div>
</div><!-- Header 3 Ends Here -->