        ...
        <div class="row">
            <div class="col-md-12">
                <div class="inner-banner-content">
                    <h1 class="head-text">Products</h1>
                        ...
                        <div class="cat-box">
                            <ul class="ac-category list-unstyled">
                                ...
                                <li>
                                    ...
                                    <a href="javascript:void(0)" class="p-text category-link" id="category-id-{{ $list->id }}" data-id="{{ $list->id }}">{{ $list->categoryName }}</a>
                                </li>
                                @endforeach
                            </ul>
                        </div>
        ...
        $.fn.showProduct = function(d){
            ...
            $.each(product, function (index, value) {
                ...
                $.each(image[value.id], function (i2, v2) {
                    var everyImage = '<img src="'+pageurl+'/public/storage/product/'+v2.imageName+'" class="img-thumbnail" title="Product Image">';
