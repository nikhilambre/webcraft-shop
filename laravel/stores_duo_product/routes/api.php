...
Route::group(['prefix' => 'dashboard', 'middleware' => ['auth:api']], function() {
    ...
    //  Routes for Help actions
    Route::post('/help', 'Dashboard\HelpController@postHelp')->name('help.post');
    Route::get('/helps', 'Dashboard\HelpController@getHelps')->name('help.getAll');
    Route::get('/help/{id}', 'Dashboard\HelpController@getHelp')->name('help.get');
    Route::post('/help/{id}', 'Dashboard\HelpController@putHelp')->name('help.put');
    //Route::delete('/help/{id}', 'Dashboard\HelpController@deleteHelp')->name('help.delete');
    ...
    //Route::post('/enquery', 'Dashboard\EnquiryController@postEnquiry')->name('enquiry.post');
    Route::get('/enquerys', 'Dashboard\EnquiryController@getEnquirys')->name('enquiry.getAll');
    Route::get('/enquery/{id}', 'Dashboard\EnquiryController@getEnquiry')->name('enquiry.get');
    //Route::post('/enquery/{id}', 'Dashboard\EnquiryController@putEnquiry')->name('enquiry.put');
    Route::delete('/enquery/{id}', 'Dashboard\EnquiryController@deleteEnquiry')->name('enquiry.delete');
