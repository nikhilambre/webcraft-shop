...
class BlogController extends Controller
{
    ...
    public function getAboutPage()
    {
        ...
        $sectionContent = Editsection::select('id','sectionId','sectionCode','pageName','contentType','sectionContent','created_at')
                                ->where('pageName', $pageName)
                                ->get();

        $sectionImages = Editsection::select('id','sectionId','sectionCode','pageName','sectionContent','created_at')
                                ->where('pageName', $pageName)
