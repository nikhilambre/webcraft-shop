...
class BlogShopController extends Controller
{
    ...
    public function ajaxFilterWiseProduct(Request $request)
    {
        ...
        if (isset($request->filterList)) {
            ...
            $productListData = Product::select('products.id','productDisplayId','productName','productNameSlug','shortDescription','mark','view','productStock','price','currency','discount','finalPrice','products.created_at')
