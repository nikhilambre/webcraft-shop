...
class ProductPriceController extends Controller
{
    ...
    public function getPrices()
    {
        ...
        $productprice = Productprice::select('productprices.id','productId','productName','productDisplayId','price','currency','priceForQnt','discount','tax','finalPrice', 'productprices.created_at')
    ...
    {
        $productprice = Productprice::select('productprices.id','productId','productName','productDisplayId','currency','finalPrice','discount','tax','priceForQnt','productprices.created_at')
                            ->leftJoin('products', 'productprices.productId', '=', 'products.id')
