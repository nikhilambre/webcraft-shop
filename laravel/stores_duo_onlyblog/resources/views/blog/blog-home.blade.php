...
<div id="carousel-example-generic" class="he-17-carousel carousel slide" data-ride="carousel">
    <!-- Indicators -->
    ...
    <div class="carousel-inner" role="listbox">
        <div class="item active">
            <div class="carousel-caption">
                <h2 class="" data-animation="animated fadeInUp">Rank Your Site At Top From Other!</h2>
                <p class="" data-animation="animated fadeInUp">Nullam id dolor id nibh ultricies vehicula ut id elit. Duis mollis, est non commodo luctus.</p>
                <a href="javascript:void(0)" class="link">View Post</a>
            </div>
            <div class="img-box" style="background-image: linear-gradient(rgba(0,0,0,0.5),rgba(0,0,0,0.5)), url('public/images/p1.jpeg')"></div>
        </div>
        <div class="item">
            <div class="carousel-caption">
                <h2 class="" data-animation="animated fadeInUp">Rank Your Site At Top From Other!</h2>
            ...
            <div class="img-box" style="background-image: linear-gradient(rgba(0,0,0,0.5),rgba(0,0,0,0.5)), url('public/images/p2.jpeg')"></div>
        </div>
        <div class="item">
            <div class="carousel-caption">
                <h2 class="" data-animation="animated fadeInUp">Rank Your Site At Top From Other!</h2>
            ...
            <div class="img-box" style="background-image: linear-gradient(rgba(0,0,0,0.5),rgba(0,0,0,0.5)), url('public/images/p3.jpeg')"></div>
        </div>
    </div>
