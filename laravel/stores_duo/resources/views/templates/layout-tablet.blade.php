...
<body class="">
    ...
    <nav class="navbar-navb navbar navbar-default navbar-fixed-bottom"><div class="container-fluid">
        ...
        <div class="navbar-header navbar-header-single">
        ...
        --><div class="navb-devices">
            <a href="{{ url('/template/mobile/'.$type.'/'.$typeId.'/'.$subType) }}" class="navb-icon text-center" title="Show in Mobile View"><i class="fa fa-mobile"></i></a><!--
            --><a href="{{ url('/template/desktop/'.$type.'/'.$typeId.'/'.$subType) }}" class="navb-icon text-center" title="Show in Desktop View"><i class="fa fa-desktop"></i></a><!--
            --><a href="{{ url('/template/tablet/'.$type.'/'.$typeId.'/'.$subType) }}" class="navb-icon text-center" title="Show in Tablet View"><i class="fa fa-tablet"></i></a>
        </div><!--
