...
<body class="">
    ...
    <nav class="navbar-navb navbar navbar-default navbar-fixed-bottom"><div class="container-fluid">
        ...
        --><div class="navb-devices">
            @if ($type == 'component')
                <a href="{{ url('/listing/mobile/'.$type.'/'.$subType.'?sort=typeId&page='.$template->currentPage()) }}" class="navb-icon text-center" title="Show in Mobile View"><i class="fa fa-mobile"></i></a><!--
            --><a href="{{ url('/listing/desktop/'.$type.'/'.$subType.'?sort=typeId&page='.$template->currentPage()) }}" class="navb-icon text-center" title="Show in Desktop View"><i class="fa fa-desktop"></i></a><!--
            --><a href="{{ url('/listing/tablet/'.$type.'/'.$subType.'?sort=typeId&page='.$template->currentPage()) }}" class="navb-icon text-center" title="Show in Tablet View"><i class="fa fa-tablet"></i></a>
            @else
                <a href="{{ url('/listing/mobile/'.$type.'?sort=typeId&page='.$template->currentPage()) }}" class="navb-icon text-center" title="Show in Mobile View"><i class="fa fa-mobile"></i></a><!--
            --><a href="{{ url('/listing/desktop/'.$type.'?sort=typeId&page='.$template->currentPage()) }}" class="navb-icon text-center" title="Show in Desktop View"><i class="fa fa-desktop"></i></a><!--
            --><a href="{{ url('/listing/tablet/'.$type.'?sort=typeId&page='.$template->currentPage()) }}" class="navb-icon text-center" title="Show in Tablet View"><i class="fa fa-tablet"></i></a>
            @endif
        </div><!--
    ...
    <div class="mp-pusher" id="mp-pusher">
        ...
        <div class="text-center">
            <div class="tablet-view">
                <iframe class="iframe-tablet" name="iframe-tablet" src="{{ url('/template/iframe/'.$view.'/'.$type.'/'.$typeId.'/'.$subType) }}" frameborder="0"></iframe>
            </div>
        </div>
