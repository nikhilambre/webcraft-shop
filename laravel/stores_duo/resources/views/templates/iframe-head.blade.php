...
<title>WebCraft Shop - Sample | Build your own website | Website Creator | E commerce web store</title>
...
{{-- <link rel="stylesheet" href="{{ asset('template/css/structure.css') }}" type='text/css' /> --}}
