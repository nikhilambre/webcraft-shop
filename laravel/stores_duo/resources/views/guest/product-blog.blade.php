...
@section('title')
Blog Websites - WebCraft Shop | Build your own website | Websites store India
@endsection
...
<div class="nb-home">
    ...
    <div class="container">
        <div class="home-box">
            <h2 class="home-h2">Blog Websites</h2>
...
<div class="ni-sec-1 nis12 p80_">
    <div class="container">
        <div class="ni1-head row">
            <h2 class="ni1-h2 text-center">Blog Websites Features</h2>
        </div>
        ...
        <div class="row ni1-text-cover">
            <div class="ni1-text ni1-text-hover col-xs-12 col-sm-4">
                ...
                <h4 class="ni1-h4">Blog Websites supports wide range of Bloggers profile and we are continuesly working to build new designs. Multiple Author feature also supports Theme blogging website.</h4>
                <ul class="ni1-ul list-unstyled">
                    <li class=""><i class="fa fa-caret-square-right"></i>Blog Home Page</li>
                    <li class=""><i class="fa fa-caret-square-right"></i>About Us &amp; Contact Us Pages</li>
                    <li class=""><i class="fa fa-caret-square-right"></i>Category, Pupuler Blogs &amp; Tag wise List page</li>
                    <li class=""><i class="fa fa-caret-square-right"></i>Single Post Displau Page</li>
                    <li class=""><i class="fa fa-caret-square-right"></i>User Profile Page</li>
                    <li class=""><i class="fa fa-caret-square-right"></i>Blog Search list Page</li>
                </ul>
            </div>
            <div class="ni1-text ni1-text-hover col-xs-12 col-sm-4">
                <h3 class="ni1-h3">Blog Website Features</h3>
        ...
        <div class="row ni1-text-cover">
            <div class="ni1-text ni1-text-hover col-xs-12 col-sm-4">
                <h3 class="ni1-h3">Multiple Authors are Supported</h3>
                <h4 class="ni1-h4">You are always welcom with your Custom Ideas, We Have experties to build any complex requirment you have. Prizing and Time Requirments will as per complexity of Project. Leave us a Message and we will Contact you.</h4>
            </div>
            <div class="ni1-text ni1-text-hover col-xs-12 col-sm-4">
                <h3 class="ni1-h3">Social Media Login Method Supported</h3>
                <h4 class="ni1-h4">We also support signup with Social Media platforms like Facebook, Google, Twitter, Github, Linked In and many more.</h4>
            </div>
        </div>
    </div>
</div>
