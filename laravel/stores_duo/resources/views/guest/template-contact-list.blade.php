...
@section('title')
Contact Components - WebCraft Shop | Build your own website | Websites store India
@endsection
...
<div class="nb-home">
    ...
    <div class="container">
        <div class="home-box">
            <h2 class="home-h2">Contact Designs</h2>
...
<div class="design-list"><div class="container">
    <h2 class="head-h2">Contact Page Designs List</h2>

    <div class="list row">
        @if($template->isEmpty())
        <p>No Component Present</p>
        @endif
