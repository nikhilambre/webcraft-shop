...
@section('title')
Order Status - WebCraft Shop | Build your own website | Websites store India
@endsection
...
<div class="nx-status"><div class="container p40_">
    ...
    <div class="nx-saved"><div class="container p40_">
        <p>We need above data from you to upload in your webpages. As we receive data will mark it in above List</p>
...
<div class="nx-comments"><div class="container p20_">
            ...
            <li>
                <form class="" name="form-comm" method="post">
                    <div class="form-group row p10_">
                        <label for="commentText" class="com-name hidden-xs col-sm-2 col-md-2 col-lg-2 text-right">Message : </label>
    ...
    <div class="nx-com-help col-xs-12 col-sm-5 col-md-5 col-lg-5">
        ...
        <ul class="list-unstyled">
            <li><i class="fa fa-angle-double-right"></i><a href="javascript:void(0)">How to select domain name?</a></li>
            <li><i class="fa fa-angle-double-right"></i><a href="javascript:void(0)">How to select title, keywords & description for better SEO performance?</a></li>
            <li><i class="fa fa-angle-double-right"></i><a href="javascript:void(0)">Products by WebCraft Shop.</a></li>
            <li><i class="fa fa-angle-double-right"></i><a href="javascript:void(0)">How to apply for payment gateway in India (CCAVENUE PG)?</a></li>
            <li><i class="fa fa-angle-double-right"></i><a href="javascript:void(0)">How to add google analytics to your website?</a></li>
            <li><i class="fa fa-angle-double-right"></i><a href="javascript:void(0)">How to get code for tawk.to for chat integration?</a></li>
        </ul><br><br>
