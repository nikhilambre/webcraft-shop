...
Route::group(['prefix' => 'dashboard', 'middleware' => ['auth:api']], function() {
    ...
    //  Routes for Order
    Route::post('/order', 'Dashboard\OrderController@postOrder')->name('Order.post');
    ...
    Route::get('/orderdata/{id}', 'Dashboard\OrderChoiceController@getOrderUserDataStatus')->name('userdata.get');
    Route::post('/orderdata', 'Dashboard\OrderChoiceController@postOrderUserDataStatus')->name('userdata.post');
