...
class BlogHomeController extends Controller
{
    ...
    public function getPost()
    {
        ...
        $commentValues = $this->linearDates($dateNum, $commentDate, $commentVal);
        ...
        $likeValues = $this->linearDates($dateNum, $likeDate, $likeVal);
    ...
    protected function linearDates($dateNum, $dates , $val)
    {
        $insertedVal = array('0');
        ...
        for ($i=0; $i<11; $i++) {
            ...
            if ($i == sizeof($dateNum)){
                $insertedDate = $dateBeforxDays.'-'.$monthBeforxDays;

                array_splice($dateNum, $i, 0, $dateBeforxDays);
                array_splice($dates, $i, 0, $insertedDate);
                array_splice($val, $i, 0, $insertedVal);
            }
            elseif ($dateNum[$i] != $dateBeforxDays) {
                $insertedDate = $dateBeforxDays.'-'.$monthBeforxDays;
