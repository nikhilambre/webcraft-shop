...
class ProductController extends Controller
{
    public function postProduct(Request $request)
    {
        $this->validate($request, [
            ...
            'status' => 'required',
            'productStock' => 'numeric|max:10000',
            'mark' => 'max:40'
        ]);
    ...
    public function getProducts()
    {
        ...
        $product = Product::select('id','productName', 'productDisplayId', 'status','productStock','created_at')
                            ->get();
    ...
    {
        $product = Product::select('id','productName','productDisplayId','description', 'shortDescription', 'status','productStock','mark', 'created_at as productCreated')
                            ->where('id', '=', $id)
                            ->get()->toArray();
