...
class MessageController extends Controller
{
    public function postMessage(Request $request)
    {
        ...
        */
        ...
        $recentupdate->type = 'message';
        $recentupdate->mapCode = $message->id;
        $recentupdate->text41 = $request->input('messageName');
        $recentupdate->text42 = 'Message';
        $recentupdate->text43 = $message->id;
        $recentupdate->save();
    ...
    public function deleteMessage($id)
    {
        ...
        $recentupdate = Recentupdate::where('mapCode', $id)->where('type', 'message')->first();
        $recentupdate->delete();
