...
class BlogPostController extends Controller
{
    ...
    {
        $blogposts = Blogpost::select('blogposts.id','categoryId','categoryName','authorId','authorName','postTitle','postSubTitle','postContent','readMinutes','postStatus','postRank','commentStatus','commentCount','likeCount','view','blogposts.created_at')
                            ->leftJoin('blogauthors', 'blogposts.authorId', '=', 'blogauthors.id')
                            ->leftJoin('blogcategors', 'blogposts.categoryId', '=', 'blogcategors.id')
