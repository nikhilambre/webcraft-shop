...
class TemplateController extends Controller
{
    public function postTemplate(Request $request)
    {
        ...
        */
        ...
        $template->templateImage = $request->input('templateImage');
        $template->htmlLaravelContent = $request->input('htmlLaravelContent');
    ...
    {
        $template = Template::select('id','type','typeId','subType','typeName','typeDescription','htmlContent','templateImage','htmlLaravelContent','customStyle','vendorStyle','fonts','vendorScripts','scripts','created_at')
                            ->where('id', '=', $id)
                            ->get();
