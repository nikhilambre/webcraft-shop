...
Route::get('/shop', 'Blog\BlogShopController@getShopListPage')->name('blog.shop');
Route::get('/product/{productNameSlug}', 'Blog\BlogShopController@getProductPage')->name('blog.product');
...
Route::group(['middleware' => ['auth:customer']], function () {
    Route::get('/cart', 'Blog\BlogCartController@getCartPage')->name('blog.cart');
    ...
    Route::get('/wishlist', 'Blog\BlogManageController@getWishlistPage')->name('blog.wishlist');
    Route::get('/order', 'Blog\BlogOrderController@getOrderPage')->name('blog.order');
    Route::post('/order', 'Blog\BlogOrderController@postOrderPage')->name('blog.post.order');

    Route::get('/payment', 'Blog\BlogPaymentController@index')->name('blog.payment');    
});
