                    ...
                    <div class="ab-side-prd">
                        ...
                        <div class="ad-prd-sugg">
                            <div class="ad-prd-img">
                                <img src="../public/storage/product/image_5b3259e3e3633.jpg" class="img-responsive" />
                            </div>
                            <div class="ad-prd-cont">
                                <h4>Maecenas volutpat lorem ut ex lobortis</h4>
                                <div class="item-price text-left">
                                    <span class="pri-new"><i class="fa fa-inr"></i> 2550</span>
                                    <span class="pri-old hidden"><i class="fa fa-inr"></i> 3650</span>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="ad-prd-sugg">
                            <div class="ad-prd-img">
                                <img src="../public/storage/product/image_5b3259e3b161e.jpg" class="img-responsive" />
                            </div>
                            <div class="ad-prd-cont">
                                <h4>Vivamus sodales, justo at euismod venenatis</h4>
                                <div class="item-price text-left">
                                    <span class="pri-new"><i class="fa fa-inr"></i> 3556</span>
                                    <span class="pri-old hidden"><i class="fa fa-inr"></i> 4565</span>
                                </div>
                            </div>
                        </div>
                    </div>
